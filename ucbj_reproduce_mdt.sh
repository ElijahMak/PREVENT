...
seg="$SUBJECTS_DIR/${subject}/noddi/wmparc_2_b0_mdt.nii"
...
# NODDI
mri_segstats --seg ${seg} --ctab $FREESURFER_HOME/FreeSurferColorLUT.txt --excludeid 0 --sum ${wmparc_stats} --i ${mdt_odi_gm}

mri_segstats --seg ${seg} --ctab $FREESURFER_HOME/FreeSurferColorLUT.txt --excludeid 0 --sum ${aparcaseg_stats} --i ${mdt_odi_gm}
