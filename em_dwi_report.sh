...
autoaq -i ${i}_IIT_NN.nii.gz -a "JHU White-Matter Tractography Atlas" -t 1.3 -o ${i}_IIT.txt -p



applywarp -i ${i}.nii -o ${i}_MNI152.nii -r $FSLDIR/data/standard/FMRIB58_FA_1mm.nii.gz --premat=flirt.mat --interp=nn
applywarp -i filled_${i}.nii.gz -o filled_${i}_MNI152.nii.gz -r $FSLDIR/data/standard/FMRIB58_FA_1mm.nii.gz --premat=flirt.mat --interp=nn

autoaq -i ${i}_MNI152.nii.gz -a "JHU White-Matter Tractography Atlas" -t 1.3 -o ${i}_MNI152.txt -p
