...
echo "--------------------------------"
  ...
  dwifslpreproc ${denoised_degibbs_dwi} ${denoised_degibbs_preproc_dwi} -rpe_header -eddyqc_all eddyqc -eddy_mask hifi_nodif_brain_ f0.3_mask.nii -eddy_options '  --repol --data_is_shelled --slm=linear'
