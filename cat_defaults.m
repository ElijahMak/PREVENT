...
cat.extopts.print        = 0;     % display and print out pdf-file of results: 0 - off, 1 - volume only (use this to avoid problems on servers that do not support openGL), 2 - volume and surface (default)
...
cat.extopts.atlas       = { ...
  ...
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','hammers.nii')             1      {'csf','gm','wm'}   1; ... % atlas based on 20 subjects
